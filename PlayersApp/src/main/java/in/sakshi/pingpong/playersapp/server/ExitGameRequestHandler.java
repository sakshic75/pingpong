...
public class ExitGameRequestHandler implements HttpHandler, EventPublisher<InputStream> {

    private final List<EventListener<InputStream>> listeners = new ArrayList<>();
    private String responseBody;
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        notifyAll(Constants.EXIT_REQUEST_HANDLER_SUBJECT,exchange.getRequestBody())    ;
