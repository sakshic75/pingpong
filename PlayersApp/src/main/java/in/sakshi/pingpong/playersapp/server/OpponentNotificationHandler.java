...
public class OpponentNotificationHandler implements HttpHandler, EventPublisher<InputStream> {
    private final List<EventListener<InputStream>> listeners = new ArrayList<>();
    private String responseBody;
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        notifyAll(Constants.OPPONENT_REQUEST_HANDLER_SUBJECT,exchange.getRequestBody());
